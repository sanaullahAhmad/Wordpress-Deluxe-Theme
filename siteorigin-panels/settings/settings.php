...
class SiteOrigin_Panels_Settings {
	...
	function add_settings_page(){
		$page = add_options_page( __('Deluxe Page Builder', 'siteorigin-panels'), __('Page Builder', 'siteorigin-panels'), 'manage_options', 'siteorigin_panels', array($this, 'display_settings_page') );
	...
	function display_settings_page(){
		...
		include get_template_directory() . '/siteorigin-panels//tpl/settings.php';
	}
