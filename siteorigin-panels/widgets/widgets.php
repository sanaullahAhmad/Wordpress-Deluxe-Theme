...
include get_template_directory() . '/siteorigin-panels/widgets/less/functions.php';

/**
 * Include all the widget files and register their widgets
 */
function origin_widgets_init(){
	foreach(glob(get_template_directory() . '/siteorigin-panels/widgets*/*.php') as $file) {
		include_once ($file);
...
function origin_widgets_enqueue($prefix){
	if($prefix == 'widgets.php') wp_enqueue_script('origin-widgets-admin-script', get_template_directory() . '/siteorigin-panels/widgets/js/admin.js', array('jquery'), SITEORIGIN_PANELS_VERSION);
}
...
abstract class SiteOrigin_Panels_Widget extends WP_Widget{
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	// Extra functions specific to a Deluxe widget.
	////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function create_css($style, $preset) {
		...
		if( !class_exists('lessc') ) include get_template_directory() . '/siteorigin-panels/lib/lessc.inc.php';
		...
		$less = str_replace(
			'@import "../../../less/mixins";',
			"\n\n".file_get_contents(get_template_directory() . '/siteorigin-panels/less/mixins.less'),
			$less
		);
