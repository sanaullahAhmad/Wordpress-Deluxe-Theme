...
function siteorigin_panels_live_editor_frontend_scripts(){
	wp_enqueue_script(
		'live-editor-front',
		get_template_directory() . '/siteorigin-panels/js/live-editor/live-editor-front' . SITEORIGIN_PANELS_JS_SUFFIX . '.js',
		array( 'jquery' ),
	...
	wp_enqueue_script(
		...
		get_template_directory() . '/siteorigin-panels/js/live-editor/jquery.scrollTo' . SITEORIGIN_PANELS_JS_SUFFIX . '.js',
		array( 'jquery' ),
		SITEORIGIN_PANELS_VERSION
	);
	...
	wp_enqueue_style(
		'live-editor-front',
		get_template_directory() . '/siteorigin-panels/css/live-editor-front.css',
		array(),
		SITEORIGIN_PANELS_VERSION
	);
}
