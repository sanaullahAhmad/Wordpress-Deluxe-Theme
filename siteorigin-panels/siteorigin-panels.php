...
require_once get_template_directory() . '/siteorigin-panels/settings/settings.php';

// Include all the basic widgets
require_once get_template_directory() . '/siteorigin-panels/widgets/basic.php';
require_once get_template_directory() . '/siteorigin-panels/widgets/migration.php';

require_once get_template_directory() . '/siteorigin-panels/inc/css.php';
require_once get_template_directory() . '/siteorigin-panels/inc/revisions.php';
require_once get_template_directory() . '/siteorigin-panels/inc/styles.php';
require_once get_template_directory() . '/siteorigin-panels/inc/default-styles.php';
require_once get_template_directory() . '/siteorigin-panels/inc/widgets.php';
require_once get_template_directory() . '/siteorigin-panels/inc/plugin-activation.php';
require_once get_template_directory() . '/siteorigin-panels/inc/admin-actions.php';
require_once get_template_directory() . '/siteorigin-panels/inc/sidebars-emulator.php';
require_once get_template_directory() . '/so-widgets-bundle/so-widgets-bundle.php';

if( defined('SITEORIGIN_PANELS_DEV') && SITEORIGIN_PANELS_DEV ) include get_template_directory() . '/siteorigin-panels/inc/debug.php';
...
add_action( 'wp_loaded', 'siteorigin_panels_activate' );
/**
...
function siteorigin_panels_init(){
	...
	if( !defined('SITEORIGIN_PANELS_LEGACY_WIDGETS_ACTIVE') && ( !is_admin() || basename($_SERVER["SCRIPT_FILENAME"]) != 'plugins.php') ) {
		...
		include get_template_directory() . '/siteorigin-panels/widgets/widgets.php';
	}
}
...
function siteorigin_panels_render_admin_home_page(){
	...
	include get_template_directory() . '/siteorigin-panels/tpl/admin-home-page.php';
}
...
function siteorigin_panels_metaboxes() {
	foreach( siteorigin_panels_setting( 'post-types' ) as $type ){
		add_meta_box(
			'so-panels-panels',
			__( 'Page Composer', 'siteorigin-panels' ),
...
function siteorigin_panels_metabox_render( $post ) {
	$panels_data = siteorigin_panels_get_current_admin_panels_data();
	include get_template_directory() . '/siteorigin-panels/tpl/metabox-panels.php';
}
...
function siteorigin_panels_admin_enqueue_scripts( $prefix = '', $force = false ) {
	...
	if ( $force || siteorigin_panels_is_admin_page() ) {
		...
		wp_enqueue_media();
		wp_enqueue_script( 'so-panels-admin', get_template_directory_uri() . '/siteorigin-panels/js/siteorigin-panels' . SITEORIGIN_PANELS_VERSION_SUFFIX . SITEORIGIN_PANELS_JS_SUFFIX . '.js', array( 'jquery', 'jquery-ui-resizable', 'jquery-ui-sortable', 'jquery-ui-draggable', 'underscore', 'backbone', 'plupload', 'plupload-all' ), SITEORIGIN_PANELS_VERSION, true );
		...
		wp_localize_script( 'so-panels-admin', 'panelsOptions', array(
			...
			'prebuiltDefaultScreenshot' => get_template_directory_uri() . '/siteorigin-panels/css/images/prebuilt-default.png',
		));
...
function siteorigin_panels_js_templates(){
	include get_template_directory() . '/siteorigin-panels/tpl/js-templates.php';
}
...
function siteorigin_panels_admin_enqueue_styles( $prefix = '', $force = false ) {
	if ( $force || siteorigin_panels_is_admin_page() ) {
		wp_enqueue_style( 'so-panels-admin', get_template_directory_uri() . '/siteorigin-panels/css/admin.css', array( 'wp-color-picker' ), SITEORIGIN_PANELS_VERSION );
...
function siteorigin_panels_add_help_tab_content(){
	include get_template_directory() . '/siteorigin-panels/tpl/help.php';
}
...
if( !empty($_GET['siteorigin_panels_live_editor']) ) require_once get_template_directory() . '/siteorigin-panels/inc/live-editor.php';
