...
The Deluxe widget bundle gives you a collection of widgets that you can use and customize. All the widgets are built on our powerful framework, giving you advanced forms, unlimited colours and 1500+ icons.
...
Once you enable a widget, you'll be able to use it anywhere standard widgets are used. You can manage your widgets by going to Plugins > Deluxe Widgets in your WordPress admin.
...
We offer free support on the [Deluxe support forums](https://siteorigin.com/thread/).

= Create Custom Widgets =

The Deluxe Widgets Bundle is the perfect platform to build widgets for your theme or plugin. Read more on our [developer docs](https://siteorigin.com/docs/widgets-bundle/).
...
* Image: Added filter for Deluxe image attributes.
...
* Allow unfiltered HTML in Deluxe Editor Widget if user has rights.
