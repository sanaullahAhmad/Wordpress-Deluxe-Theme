<div class="wrap" id="sow-widgets-page">
	<div class="page-banner">
		...
		<span class="icon">
			<img src="<?php echo get_template_directory_uri() ?>/so-widgets-bundle/admin/images/icon-back.png" class="icon-back" width="50" height="43">
			<img src="<?php echo get_template_directory_uri() ?>/so-widgets-bundle/admin/images/icon-gear.png" class="icon-gear" width="26" height="26">
			<img src="<?php echo get_template_directory_uri() ?>/so-widgets-bundle/admin/images/icon-front.png" class="icon-front" width="50" height="43">
		</span>
		<h1><?php _e('Deluxe Widgets Bundle', 'so-widgets-bundle') ?></h1>
		...
		<?php foreach( $widgets as $id => $widget ): ?>
			<div class="so-widget-wrap">
				<div class="so-widget so-widget-is-<?php echo $widget['Active'] ? 'active' : 'inactive' ?>" data-id="<?php echo esc_attr( $widget['ID'] ) ?>">
					...
					<?php
					$banner = '';
					if( file_exists( get_template_directory_uri() . '/so-widgets-bundle/widgets/social-media-buttons/assets/banner.svg' ) ) {
						$banner = get_template_directory_uri() . '/so-widgets-bundle/widgets/social-media-buttons/assets/banner.svg';
					}
					...
					<div class="so-widget-text">
						...
						<?php if( !empty( $widget['Author'] ) ) : ?>
							<?php /*?><div class="so-widget-byline">
								By
								<strong>
								<?php
