...
class SiteOrigin_Widget_Field_TinyMCE extends SiteOrigin_Widget_Field_Text_Input_Base {
	...
	public function enqueue_scripts() {
		wp_enqueue_script( 'so-tinymce-field', get_template_directory_uri() . '/so-widgets-bundle/base/inc/fields/js/tinymce-field' . SOW_BUNDLE_JS_SUFFIX . '.js', array( 'jquery', 'editor', 'quicktags' ), SOW_BUNDLE_VERSION );
		wp_enqueue_style( 'so-tinymce-field', get_template_directory_uri() . '/so-widgets-bundle/base/inc/fields/css/tinymce-field.css', array(), SOW_BUNDLE_VERSION );
	}
