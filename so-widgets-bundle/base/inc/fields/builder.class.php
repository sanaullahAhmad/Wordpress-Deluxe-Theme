...
/**
 * A full instance of Deluxe Page Builder as a field.
 *
	...
	protected function render_field( $value, $instance ){
		if( defined('SITEORIGIN_PANELS_VERSION') ) {
			...
			<p>
				...
				<a href="https://siteorigin.com/page-builder/" target="_blank"><?php _e( 'Deluxe Page Builder', 'so-widgets-bundle' ) ?></a>
			</p>
			<?php
		}
	}
