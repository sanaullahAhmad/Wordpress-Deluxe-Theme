...
class SiteOrigin_Widget_Field_Order extends SiteOrigin_Widget_Field_Base {
    ...
    public function enqueue_scripts() {
        wp_enqueue_script( 'so-order-field', get_template_directory_uri() . '/so-widgets-bundle/base/inc/fields/js/order-field' . SOW_BUNDLE_JS_SUFFIX . '.js', array( 'jquery', 'jquery-ui-sortable' ), SOW_BUNDLE_VERSION );
        wp_enqueue_style( 'so-order-field', get_template_directory_uri() . '/so-widgets-bundle/base/inc/fields/css/order-field.css', array( ), SOW_BUNDLE_VERSION );
    }
