...
class SiteOrigin_Widget_Field_Media extends SiteOrigin_Widget_Field_Base {
	...
	function enqueue_scripts(){
		wp_enqueue_script( 'so-media-field', get_template_directory_uri() . '/so-widgets-bundle/base/inc/fields/js/media-field' . SOW_BUNDLE_JS_SUFFIX .  '.js', array( 'jquery' ), SOW_BUNDLE_VERSION );
		wp_enqueue_style( 'so-media-field', get_template_directory_uri() . '/so-widgets-bundle/base/inc/fields/css/media-field.css', array( ), SOW_BUNDLE_VERSION );
	}
