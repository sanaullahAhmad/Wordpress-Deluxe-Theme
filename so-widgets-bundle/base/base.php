...
include get_template_directory() . '/so-widgets-bundle/base/inc/fields/siteorigin-widget-field-class-loader.class.php';
include get_template_directory() . '/so-widgets-bundle/base/siteorigin-widget.class.php';

include get_template_directory() . '/so-widgets-bundle/base/inc/widget-manager.class.php';
include get_template_directory() . '/so-widgets-bundle/base/inc/meta-box-manager.php';
include get_template_directory() . '/so-widgets-bundle/base/inc/post-selector.php';
include get_template_directory() . '/so-widgets-bundle/base/inc/string-utils.php';
include get_template_directory() . '/so-widgets-bundle/base/inc/attachments.php';
include get_template_directory() . '/so-widgets-bundle/base/inc/actions.php';
...
function siteorigin_widgets_fonts_google_webfonts( ) {
	$fonts = include get_template_directory() . '/so-widgets-bundle/inc/fonts.php';
