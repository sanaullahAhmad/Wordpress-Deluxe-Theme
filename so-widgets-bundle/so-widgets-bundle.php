...
if( !function_exists('siteorigin_widget_get_plugin_path') ) {
	include get_template_directory() . '/so-widgets-bundle/base/base.php';
	include get_template_directory() . '/so-widgets-bundle/icons/icons.php';
}
...
class SiteOrigin_Widgets_Bundle {
	...
	function clear_widget_cache() {
		// Remove all cached CSS for Deluxe Widgets
	...
	function display_admin_notices() {
		...
		?>
		<div class="updated">
			<p><?php echo __( 'New widgets available in the ') . '<a href="' . admin_url('plugins.php?page=so-widgets-plugins') . '">' . __('Deluxe Widgets Bundle', 'so-widgets-bundle' ) . '</a>!'; ?></p>
			<?php
	...
	function get_widget_folders(){
		if( empty($this->widget_folders) ) {
			...
			$this->widget_folders = apply_filters('siteorigin_widgets_widget_folders', array(
				get_template_directory() . '/so-widgets-bundle/widgets/'
			) );
		}
	...
	function admin_enqueue_scripts($prefix) {
		...
		wp_enqueue_style( 'siteorigin-widgets-manage-admin', get_template_directory_uri() . '/so-widgets-bundle/admin/admin.css', array(), SOW_BUNDLE_VERSION );
		wp_enqueue_script( 'siteorigin-widgets-trianglify', get_template_directory_uri() . '/so-widgets-bundle/admin/trianglify' . SOW_BUNDLE_JS_SUFFIX . '.js', array(), SOW_BUNDLE_VERSION );
		wp_enqueue_script( 'siteorigin-widgets-manage-admin', get_template_directory_uri() . '/so-widgets-bundle/admin/admin' . SOW_BUNDLE_JS_SUFFIX . '.js', array(), SOW_BUNDLE_VERSION );
	...
	function admin_menu_init(){
		add_plugins_page(
			__('Deluxe Widgets', 'so-widgets-bundle'),
			__('Deluxe Widgets', 'so-widgets-bundle'),
	...
	function admin_page(){
		...
		include get_template_directory() . '/so-widgets-bundle/admin/tpl/admin.php';
	}
